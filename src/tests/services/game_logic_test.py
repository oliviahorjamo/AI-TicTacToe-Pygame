...
class TestGameLogic(unittest.TestCase):
    ...
    def test_check_for_horizontal_win(self):
        ...
        self.assertEqual(self.game.check_for_win(self.board), (False, None))
        self.game.insert_move('X', 0, 0, self.board)
        self.game.insert_move('X', 0, 14, self.board)
        self.assertEqual(self.game.check_for_win(self.board), (False, None))
    ...
    def test_check_for_vertical_win(self):
        ...
        self.assertEqual(self.game.check_for_win(self.board), (False, None))
        self.game.insert_move('X', 0, 0, self.board)
        self.game.insert_move('X', 14, 14, self.board)
        self.assertEqual(self.game.check_for_win(self.board), (False, None))
    ...
    def test_empty_spaces_and_tie(self):
        ...
        self.assertFalse(self.game.check_for_tie(self.board))
        self.board = [[1 for _ in range(self.board_size)] for _ in range(self.board_size)]
        self.assertTrue(self.game.check_for_tie(self.board))
